...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails,long JWT_TOKEN_VALIDITY) {
        Map<String, Object> claims = new HashMap<>();
        return doGenerateToken(claims, userDetails.getUsername(), JWT_TOKEN_VALIDITY);
    }

    public String generateTokenUsingUsername(String username, long JWT_TOKEN_VALIDITY) {
        Map<String, Object> claims = new HashMap<>();
